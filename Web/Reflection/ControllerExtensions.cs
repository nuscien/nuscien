...
public static class ControllerExtensions
{
    ...
    public static ActionResult ResourceEntityResult<T>(this ControllerBase controller, T value) where T : BaseResourceEntity
    {
        ...
        if (!controller.Response.Headers.ContainsKey("Etag")) controller.Response.Headers.Append("Etag", new Microsoft.Extensions.Primitives.StringValues($"{value.Id}-{value.Revision}"));
    ...
    public static async Task<BaseResourceAccessClient> GetResourceAccessClientAsync(this ControllerBase controller, bool doNotWrite = false)
    {
        ...
        if (!string.IsNullOrWhiteSpace(token))
            controller.Response.Headers.Append("X-Auth-Token", new Microsoft.Extensions.Primitives.StringValues(r.Token.ToString()));
