...
namespace NuScien.Sns
{
    ...
    public interface ISocialNetworkResourceDataProvider
    {
        ...
        public Task<IEnumerable<ContactEntity>> ListContactsAsync(QueryArgs q, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The optional token to monitor for cancellation requests.</param>
        /// <returns>The entity result.</returns>
        public Task<ReceivedMailEntity> GetReceivedMailAsync(string id, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The optional token to monitor for cancellation requests.</param>
        /// <returns>The entity result.</returns>
        public Task<SentMailEntity> GetSentMailAsync(string id, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The optional token to monitor for cancellation requests.</param>
        /// <returns>The collection of result.</returns>
        public Task<IEnumerable<ReceivedMailEntity>> ListReceivedMailAsync(string folder, QueryArgs q, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The optional token to monitor for cancellation requests.</param>
        /// <returns>The collection of result.</returns>
        public Task<IEnumerable<SentMailEntity>> ListSentMailAsync(string folder, QueryArgs q, CancellationToken cancellationToken);
    ...
    public class OnPremisesSocialNetworkResourceContext : BaseSocialNetworkResourceContext
    {
        ...
        {
            return await DataProvider.ListContactsAsync(q, cancellationToken);
        }
        ...
        {
            return await DataProvider.GetContactAsync(id, cancellationToken);
        }
        ...
        {
            return await DataProvider.GetReceivedMailAsync(id, cancellationToken);
        }
        ...
        {
            return await DataProvider.GetSentMailAsync(id, cancellationToken);
        }
        ...
        {
            return await DataProvider.ListReceivedMailAsync(folder, q, cancellationToken);
        }
        ...
        {
            return await DataProvider.ListSentMailAsync(folder, q, cancellationToken);
        }
